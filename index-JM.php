...
<!--[if lt IE 9]>
    ...
    <![endif]-->
    <style>
	.blink_txt{ color:#fff; font-size:13px; font-weight:600; float: right; width:180px}
...
#matter{max-width:780px; max-height:350px; width:100%; height:150px; margin-right:10px; margin-left:0px;}
	</style>
</head>
<body>
<header>
  ...
  <div class="row">
    <div class="col-lg-12" >
      <div class="jumbotron"  id="tits" >
        ...
        <p>&nbsp;</p>
        <div class="container" style="background-color:#452f6b; max-width:810px; width:100%; border-radius:15px; padding:25px">
         
        <form action="https://www.jamesmorgan.attorney/pages/age.php" method="post" name="frm1" id="frm1">

<div class="form-group">
      <p></p>
      <div class="clearfix"></div>
     <!--<div class="col-xs-12 col-sm-6 col-md-8" style="margin-left:-10px;">-->
        <select class="form-control" style="color:#452f6b">
...
<ul class="nav nav-stacked">
  <li ><a  href="#" id="hrmenu0" >General Law</a></li>
  <li>
    ...
    <li class="caption"><a  href="#" id="hrmenu1" >Family Law</a></li>
    <li><a  href="#"  id="hrmenu2">Criminal Law</a></li>
    <li><a  href="#"  id="hrmenu3" >Business Law</a></li>
    <li><a  href="#"  id="hrmenu4" >Consumer Law</a></li>
    <li><a  href="#" id="hrmenu9" >Real Estate Law</a></li>
    <li><a  href="#" id="hrmenu5" >Immigration Law</a></li>
    <li><a  href="#" id="hrmenu6" >Bankruptcy Law</a></li>
    <li><a  href="#" id="hrmenu7" >Traffic Law</a></li>
    <li><a  href="#" id="hrmenu8" >Other</a></li>
    </ul>
   
  </li>
 
</ul> -->
 <h2 style="color:#FFFF0F; padding-top:20px">Please explain your legal question below</h2><br>
...
<div class="blink_txt doc-online"><span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> <span id="blnktextonline" style="display: none;color:#FFFF0F">8 Lawyers online</span></div>
...
<footer class="text-center">
 ...
 <p>LIVE CUSTOMER SERVICE |  ABOUT |  WORK WITH US |  TERMS OF SERVICE |  PRIVACY |  CONTACT |  CLOSE MY ACCOUNT |  SITEMAP |  BLOG |  LOGIN  |  LAWYERS APPLY HERE </p>
        <p>Copyright ©  JamesMorgan.attorney. All rights reserved.</p>
        <p></p>
      </div>
    </div>
  </div>
